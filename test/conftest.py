...
async def clean_database_after_test():
    ...
    вычищает данные из всех таблиц, чтобы следующий тест зашел в девственно чистую базу.
    """
...
def create_order_for_mocktest():
    return Orders(id=1, category = "Test_cat", service = "Test_serv", description = "Test_desc", status = "ASSINGED", master = 1)    
